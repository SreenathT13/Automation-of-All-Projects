...
def header_function():
    ...
    if "Ready" in connectText.text:
        ...
        CF.take_image(pdf, EU.iframe,
                      'D:\\TenXer\\gmail_login\\EU065\\screenshot\\live_image.png',
                      'live_image.png')
        time.sleep(5)
...
class EU065:
    ...
    def light_control_function(self):
        ...
        time.sleep(5)
        CF.take_image(pdf, EU.iframe,
                      'D:\\TenXer\\gmail_login\\EU065\\screenshot\\pre_forward_live.png',
                      'pre_forward_live.png')
        time.sleep(5)
        slider = CF.driver.find_element(By.XPATH, EU.slider_button)
        CF.actions(CF.driver).move_to_element(slider).pause(1).click_and_hold(slider).move_by_offset(100, 0). \
            release().perform()
        time.sleep(5)
        ...
        CF.take_image(pdf, EU.iframe,
                      'D:\\TenXer\\gmail_login\\EU065\\screenshot\\after_forward_live.png',
    ...
    def RGB_control_function(self):
        ...
        time.sleep(5)
        CF.take_image(pdf, EU.iframe,
                      'D:\\TenXer\\gmail_login\\EU065\\screenshot\\pre_RGB_live.png',
                      'pre_RGB_live.png')
        time.sleep(5)
        CF.click_button(EU.control_path)
        CF.click_button(EU.RGB_path)
        R_slider = CF.driver.find_element(By.XPATH, EU.R_path)
        CF.actions(CF.driver).move_to_element(R_slider).pause(1).click_and_hold(R_slider). \
            move_by_offset(150, 0).release().perform()

        G_slider = CF.driver.find_element(By.XPATH, EU.G_path)
        CF.actions(CF.driver).move_to_element(G_slider).pause(1).click_and_hold(G_slider). \
            move_by_offset(150, 0).release().perform()

        B_slider = CF.driver.find_element(By.XPATH, EU.B_path)
        CF.actions(CF.driver).move_to_element(B_slider).pause(1).click_and_hold(B_slider). \
            move_by_offset(150, 0).release().perform()
        time.sleep(3)
        CF.click_button(EU.time_flight_on_button)
        ...
        CF.take_image(pdf, EU.iframe,
                      'D:\\TenXer\\gmail_login\\EU065\\screenshot\\after_RGB_live.png',
                      'after_RGB_live.png')
        CF.old_update_progress_log(pdf)
        pdf.cell(0, 7, txt=self.date_time, align='L')
...
def main():
    while 1:
        choice = int(input('This is EU065: \n'
                           '1: Light_control_function:\n'
                           '2: RGB_control_function:\n'
                           '3: Exit\n'
                           'Option: \n'))
        if choice == 1:
            stu = EU065()
